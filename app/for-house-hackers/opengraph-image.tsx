/**
 * Dynamic OG image for the /for-house-hackers persona landing page.
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "22px 64px 0 64px", display: "flex" }}>
          ...
          >
            2-4 unit owner-occupant deals modeled right: FHA 3.5% down, MIP,
            your-unit subsidy, and the year-2 move-out transition.
          </div>
        </div>

    ...
    <div className="min-h-screen bg-background">
      ...
      <main id="main" className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="prose prose-neutral max-w-none text-foreground space-y-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-extrabold text-foreground mt-10 mb-3">1. Gross rent is below 0.7% of price (the &quot;reverse 1% rule&quot;)</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-foreground mt-10 mb-3">2. Property taxes are above 2% of value</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-foreground mt-10 mb-3">3. The listing photos are aggressively staged but exclude a room</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-foreground mt-10 mb-3">4. The HOA is &quot;TBD&quot; or above $400/mo</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-foreground mt-10 mb-3">5. The building was built before 1940 and the listing doesn&apos;t mention recent capex</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-foreground mt-10 mb-3">6. The seller is &quot;motivated&quot; for a reason they won&apos;t explain</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-foreground mt-10 mb-3">7. The DSCR is below 1.0 at your actual financing</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-foreground mt-10 mb-3">The 60-second test in practice</h2>
          <p>

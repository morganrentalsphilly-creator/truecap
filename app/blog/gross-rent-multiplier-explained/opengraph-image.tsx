/**
 * Dynamic OG image for the gross rent multiplier post. Same design
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            Gross rent multiplier explained: the fastest way to screen a rental
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Price ÷ gross rent · cap-rate bridge · 1% rule · 2026
          </div>

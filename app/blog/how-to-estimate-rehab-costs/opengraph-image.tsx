/**
 * Dynamic OG image for the rehab-costs post. Same design language as
...
export const alt = "How to estimate rehab costs on a rental property — TrueCap";
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>
            Sq-ft pricing · 25% contingency · what beginners miss
          </div>

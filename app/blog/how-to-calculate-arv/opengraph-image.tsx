/**
 * Dynamic OG image for the "how to calculate ARV" post.
...
export const alt = "How to calculate ARV (after-repair value) — TrueCap";
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            What it&apos;s worth after the rehab
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Comps method · 70% rule · BRRRR refi · 2026
          </div>

/**
 * Dynamic OG image for the refinance post. Same design language as
...
export const alt = "How to refinance a rental property — TrueCap";
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>
            Rate-and-term · cash-out · DSCR · when each makes sense
          </div>

/**
 * Dynamic OG image for the pro-forma post. Same design language as
...
export const alt = "How to read a rental property pro forma — TrueCap";
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>
            The line-items most pro formas quietly understate
          </div>

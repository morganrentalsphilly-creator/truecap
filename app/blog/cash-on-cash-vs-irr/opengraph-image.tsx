/**
 * Dynamic OG image for the CoC vs IRR post. Same design language as
...
export const alt = "Cash-on-cash vs IRR — TrueCap";
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>
            Year-one snapshot vs full-hold return — when to use each
          </div>

      ...
      <main id="main" className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <article className="prose prose-slate max-w-none [&_p]:leading-relaxed [&_p]:text-foreground [&_h2]:font-extrabold [&_h2]:text-foreground [&_h2]:mt-10 [&_h2]:mb-3 [&_h3]:font-bold [&_h3]:text-foreground [&_h3]:mt-6 [&_h3]:mb-2 [&_li]:text-foreground [&_li]:leading-relaxed [&_strong]:text-foreground">
          <p>
            ...
            &rdquo; and nearly every result is a lender trying to sell you a
            DSCR loan. They&apos;ll tell you the magic number is 1.25, hand you
            a rate quote form, and stop there. That answer isn&apos;t wrong —
            it&apos;s just the lender&apos;s half of the story. The
            investor&apos;s half is what 1.25 actually does to your deal: it
            caps how much you can borrow, which caps how much you can pay for
            the property. This post covers both halves, with the worked math.
          </p>
          ...
          <div className="not-prose overflow-x-auto rounded-xl border border-border bg-card my-6">
            <table className="w-full min-w-[560px] text-sm">
              ...
              <tbody className="[&_td]:p-3 [&_td]:border-b [&_td]:border-border [&_tr:last-child_td]:border-0">
                <tr>
                  <td className="font-mono">Below 1.0</td>
                  <td className="text-muted-foreground">
                    Modeled income is below modeled debt service under this
                    formula
                  </td>
                  <td className="text-muted-foreground">
                    Program-specific; request written requirements
                  </td>
                </tr>
                <tr>
                  <td className="font-mono">1.0 – 1.15</td>
                  <td className="text-muted-foreground">
                    Thin modeled coverage; stress vacancy and expenses
                  </td>
                  <td className="text-muted-foreground">
                    Program-specific; request written requirements
                  </td>
                ...
                <tr>
                  <td className="font-mono">1.15 – 1.25</td>
                  <td className="text-muted-foreground">
                    Some modeled cushion; test property downside
                  </td>
                  <td className="text-muted-foreground">
                    Program-specific; request written requirements
                  </td>
                ...
                <tr>
                  <td className="font-mono">1.25 – 1.50</td>
                  <td className="text-muted-foreground">
                    Larger modeled cushion under this formula
                  </td>
                  <td className="text-muted-foreground">
                    Does not establish approval, pricing, or leverage
                  </td>
                </tr>
                <tr>
                  <td className="font-mono">1.50+</td>
                  <td className="text-muted-foreground">
                    Higher modeled coverage; verify every input
                  </td>
                  <td className="text-muted-foreground">
                    Does not establish approval, pricing, or leverage
                  </td>
          ...
          <p>
            How hard 1.25 is to clear also depends on where you&apos;re buying.
            Higher cap-rate metros like{" "}
            <Link
            ...
            at-asking deals clear 1.25 without touching the down payment. In a
            low cap-rate coastal metro, the same ratio usually needs the
          ...
          <p>
            If the property has no mortgage, there&apos;s no denominator — DSCR
            on a cash purchase is undefined, and honest tools report it as{" "}
            {NO_DEBT_SERVICE_DSCR_LABEL} rather than pretending it&apos;s
            infinite. For the full walkthrough of the formula, including which
            expenses belong in NOI, see our{" "}
            <Link
            ...
            . Here we&apos;ll focus on what the number means once you have it.
          </p>
          ...
          <p>
            ...
            <strong>$14,969/year</strong> in debt service. (Check any loan with
            our{" "}
            <Link
          ...
          <ul>
            <li>
              Gross rent: <strong>$31,200</strong>
            </li>
            <li>
              <Link
          ...
          <p>
            The property covers its mortgage — barely. At 1.12, roughly $153 of
            monthly cash flow stands between you and feeding the deal. It clears
            break-even but fails the 1.25 bar, which puts it squarely in the
            &ldquo;thin but workable&rdquo; band. So what would it take to make
            this deal pass? That&apos;s the question the lender SERP never
            answers.
          </p>
          ...
          <p>
            ...
            DSCR at this loan amount,&rdquo; ask &ldquo;what loan amount gets me
            to 1.25?&rdquo; Divide NOI by the target ratio:
          </p>
          <div className="bg-card border border-border rounded-xl p-5 sm:p-6 my-4 text-center">
            <div className="text-sm sm:text-base font-mono">
              Max debt service = $16,802 ÷ 1.25 = <strong>$13,442/year</strong>{" "}
              ($1,120/mo)
            </div>
          </div>
          <p>
            At 7% over 30 years, every $100,000 borrowed costs $665.30/month. A
            $1,120 payment therefore supports a loan of about{" "}
            <strong>$168,400</strong> — not the $187,500 you planned to borrow.
            To buy this duplex at $250,000 with a 1.25 DSCR, you&apos;d need
            roughly <strong>$81,600 down (32.7%)</strong> instead of $62,500
            (25%). That extra $19,100 of equity is the real-world price of the
            cushion.
          </p>
          ...
          <p>
            Or hold the down payment at 25% and solve for price instead. At 25%
            down, the loan is 75% of the purchase price, and at 7%/30yr that
            loan costs about 5.99% of the purchase price in annual debt service.
            Setting that equal to the $13,442 maximum:
          </p>
          <div className="bg-card border border-border rounded-xl p-5 sm:p-6 my-4 text-center">
            <div className="text-sm sm:text-base font-mono">
          ...
          <p>
            ...
            duplex is about{" "}
            <strong>$224,500 — roughly $25,500 (10%) below asking</strong>. (A
            lower price also trims property taxes slightly, which nudges NOI up
            — so $224,500 is mildly conservative.) This is the negotiating math
            ...
            runs this in both directions — DSCR at your numbers, and the Offer
            Ceiling that a target ratio implies.
          </p>
          ...
          <p>
            ...
            $250,000 price fixed and walk the down payment up in 5-point steps,
          ...
          <p>
            ...
            ~33% down the max-loan math landed on. But &ldquo;just put more
            down&rdquo; isn&apos;t free. The $25,000 that moves you from 25% to
            ...
            , and when the loan constant tops the cap rate you can buy your way
            into{" "}
            <Link
          ...
          <p>
            ...
            value. Some DSCR programs use a rent-to-PITIA calculation rather
            than the investor&apos;s NOI-based ratio. A common form is:
          </p>
          <div className="bg-card border border-border rounded-xl p-5 sm:p-6 my-4 text-center">
            <div className="text-sm sm:text-base font-mono">
          ...
          <p>
            ...
            <strong>1.54</strong>. The same hypothetical property scores 1.12
            under the article&apos;s NOI-based operating scenario. The
            difference comes from the selected numerator and denominator;
            confirm the actual program&apos;s treatment rather than assuming it
            excludes every operating item.
          </p>
          <p>
            This is why &ldquo;the lender approved it&rdquo; and &ldquo;the deal
            is good&rdquo; are different claims. The lender is underwriting
            their downside (foreclosure recovery), not your return. A program
            ratio can look stronger than an operating ratio when the formulas
            use different inputs, so approval should not be treated as
            validation of the property&apos;s cash flow. If you&apos;re
            comparing loan products themselves, our{" "}
            <Link
            ...
            covers rates, LTV tiers, and when they beat conventional financing.
          </p>
          ...
          <ul>
            <li>
              ...
              $14,587 and DSCR falls to <strong>0.97</strong> — under water. A
              deal that starts at 1.12 has an 8% rent cushion before it stops
              covering its own mortgage (break-even rent here is about
              $2,385/month).
            </li>
            <li>
              <strong>Rate +1 point:</strong> at 8%, the same $187,500 loan
              costs $1,376/month and the DSCR at asking drops from 1.12 to{" "}
              <strong>1.02</strong>. If you&apos;re buying with a rate-and-term
              refinance thesis, run the exit rate, not the teaser.
            </li>
            <li>
              <strong>Taxes reassessed:</strong> many counties reassess on sale.
              If taxes jump from the seller&apos;s $2,800 to your $3,750, that
              alone moves DSCR by about 0.06 on this deal.
            </li>
          </ul>
          <p>
            A good DSCR isn&apos;t just 1.25 today — it&apos;s a ratio that
            stays above 1.0 in the bad year. That&apos;s the standard commercial
          ...
          <ul>
            <li>
              <strong>A concrete rent-growth path.</strong> Inherited tenants at
              $1,050 against a $1,300 market rate is a 1.12-today,
              1.35-at-turnover story. Underwrite the turnover cost and timeline,
              not just the destination.
            </li>
            <li>
              <strong>House hacking.</strong> Owner-occupants measure the deal
              against their current rent, not against a DSCR. A duplex that
              scores 0.9 as a pure rental can still cut your housing cost in
              half.
            </li>
            <li>
          ...
          <p>
            ...
            property that pays its mortgage only when nothing goes wrong — and

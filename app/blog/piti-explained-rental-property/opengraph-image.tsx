/**
 * Dynamic OG image for the PITI post. Same design language as the
 * other anchor posts.
 */
...
export const alt = "PITI explained for rentals — TrueCap";
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            PITI explained: the real monthly payment on a rental
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Principal · interest · taxes · insurance · escrow · DSCR
          </div>

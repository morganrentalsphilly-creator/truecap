/**
 * Dynamic OG image for the "are mortgage points worth it on an investment
...
export const alt = "Are mortgage points worth it on an investment property? — TrueCap";
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            Are points worth it on a rental?
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Break-even · DSCR · the rental tax rule · 2026 math
          </div>

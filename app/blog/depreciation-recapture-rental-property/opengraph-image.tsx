/**
 * Dynamic OG image for the depreciation recapture post. Same design
 * language as the other anchor posts (brand bar, type tile, footer).
 */
...
export const alt =
  "Depreciation recapture on rental property — how the tax works at sale — TrueCap";
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            Depreciation recapture on rental property: the tax math at sale
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Unrecaptured §1250 gain · the 25% cap · five ways to defer
          </div>

/**
 * Dynamic OG image for the investment-property closing-costs post.
...
export const alt = "Closing costs on an investment property — TrueCap";
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            Closing costs on an investment property — the full breakdown
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Lender fees · title · transfer tax · prepaids
          </div>

/**
 * Dynamic OG image for the "70% rule for house flipping (and BRRRR)"
 * post. Same design language as the other anchor posts.
 */
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>
            ARV × 0.70 − rehab · the BRRRR tie-in · when 70% is wrong
          </div>

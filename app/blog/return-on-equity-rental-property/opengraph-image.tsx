/**
 * Dynamic OG image for the "return on equity" post. Same design
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            What is your rental&apos;s equity actually earning?
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Return on equity · ROE vs cash-on-cash · the refi test
          </div>

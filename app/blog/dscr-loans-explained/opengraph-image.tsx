/**
 * Dynamic OG image for the DSCR loans post. Same design language as
 * the other anchor posts.
 */

import { ImageResponse } from "next/og";

export const runtime = "edge";
export const alt = "DSCR loans explained — TrueCap";
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            What they are, when they make sense, what they cost.
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Self-employed · LLC title · past the 10-loan cap
          </div>

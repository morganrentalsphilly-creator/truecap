/**
 * Dynamic OG image for the "exit cap rate" post.
...
export const alt = "Exit cap rate for a rental — TrueCap";
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            The number that sets your sale price
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Terminal cap · sale-price &amp; IRR sensitivity · 2026
          </div>

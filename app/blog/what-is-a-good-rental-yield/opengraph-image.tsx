/**
 * Dynamic OG image for the "What is a good rental yield?" post.
...
export const alt = "What is a good rental yield for rental property? — TrueCap";
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            8-12% gross is the 2026 zone — the net number decides
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Benchmarks by market · Worked $220K example · The DSCR test
          </div>

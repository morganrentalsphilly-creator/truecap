/**
 * Dynamic OG image for the house-hacking post. Same design language
...
export const alt = "House hacking explained — TrueCap";
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>
            FHA · 5% conventional · the numbers most beginners miss
          </div>

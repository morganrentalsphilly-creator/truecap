        ...
        <article>
          ...
          <header className="mb-8">
            ...
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              ...
              basis, the first-year convention ignored. The calculation is
              three steps — build the depreciable basis, carve out the land,
              divide by 27.5 years with a mid-month adjustment in year one —
              and this guide works all three on a $250,000 duplex, then follows
              the number through your tax return: how a property that puts
              $200 a month in your pocket shows a loss to the IRS, what the
              deduction is worth in your bracket, and the allowed-or-allowable
              trap that bills you at sale for deductions you never claimed.
            </p>
          </header>
          ...
          <div className="prose prose-neutral max-w-none text-foreground space-y-6 leading-relaxed">
            ...
            <p>
              The tax code treats a rental building as a machine that wears
              out: you bought an income-producing asset with a finite life, so
              you deduct its cost gradually over that life instead of all at
              once. For residential rental property, Congress set that life at{" "}
              <strong>27.5 years</strong>, recovered on a straight line —
              roughly <strong>3.636% of the building&apos;s cost every
              year</strong>. Two things in the purchase never depreciate: the{" "}
              ...
              <strong>depreciable basis</strong> — so that&apos;s where the
              math starts. Get basis right and the rest is division; get it
              wrong and every year of the schedule inherits the error.
            </p>
            ...
            <p>
              ...
              <em>acquiring</em> the property: title insurance, transfer
              taxes, recording and legal fees, survey costs. It does{" "}
              <strong>not</strong> include the costs of obtaining the loan —
              points, origination, and lender fees amortize separately over
              the loan term — and it doesn&apos;t include prepaid taxes or
              insurance escrows, which are operating items. (The{" "}
              <Link
              ...
              sorts every line on the settlement statement into these
              buckets.) Concretely: you buy a duplex for{" "}
              <strong>$250,000</strong> and your capitalizable closing costs —
              title, transfer tax, legal, recording — come to{" "}
              <strong>$6,000</strong>. Your total basis is{" "}
            ...
            <p>
              ...
              <strong>25% land</strong>. Applied to the $256,000 basis:
              $64,000 of land, and a depreciable building basis of{" "}
              <strong>$192,000</strong>. An appraisal with a line-item land
              value works too; picking a flattering number with no support
              does not.
            </p>
            <p>
              The ratio matters more than most investors realize, because it
              scales the deduction linearly for three decades. At 20% land,
              the building basis is $204,800 and the annual deduction{" "}
              <strong>$7,447</strong>; at 25%, $192,000 and{" "}
              <strong>$6,982</strong>; at 30%, $179,200 and{" "}
              <strong>$6,516</strong>. That&apos;s a <strong>$931-a-year
              swing</strong> between the 20% and 30% assumptions — roughly
              $220 of real tax annually in a 24% bracket, compounding over the
              life of the hold. In dense coastal metros the assessor may put
              land at 40% or more; in much of the Midwest it&apos;s 10–15%.
              Use your parcel&apos;s actual ratio, not a rule of thumb.
            </p>
            ...
            <p>
              ...
              <strong>$192,000 ÷ 27.5 = $6,982 a year</strong> — $582 a month
              of deduction for owning the same building. Year one is smaller,
              because residential rental uses the{" "}
              <strong>mid-month convention</strong>: the property is treated
              as placed in service at the midpoint of the month it was ready
              and available to rent, no matter the actual day. Place the
              duplex in service in <strong>March</strong> and year one counts
              9.5 months: $192,000 × 3.636% × 9.5/12 ≈{" "}
              <strong>$5,528</strong>. A January start yields about $6,691; a
              December closing gets half a month, about <strong>$291</strong>.
              Note the trigger is <em>ready and available</em> — the day the
              unit is habitable and listed, not the day a lease starts. If you
              close in October and advertise in November, depreciation starts
              in November even if the tenant moves in come January.
            </p>
            ...
            <p>
              ...
              <strong>+$200 a month</strong> after vacancy, operating
              expenses, and the mortgage — $2,400 a year of real cash flow
              (pressure-test your own deal&apos;s number with the{" "}
              <Link
                href="/tools/rental-cash-flow-calculator"
                className="text-primary font-semibold hover:underline"
              >
                cash flow calculator
              </Link>
              ). Taxable income is a different animal: start from cash flow,
              add back the ~<strong>$1,900</strong> of year-one principal
              paydown (cash out the door, but not deductible), then subtract{" "}
              <strong>$6,982</strong> of depreciation. Result: $2,400 + $1,900
              − $6,982 = <strong>−$2,682</strong>. The property pays you
              $2,400 in cash and reports a $2,682 loss to the IRS. In a 24%
              bracket, the depreciation deduction alone shields about{" "}
              <strong>$1,676 a year</strong> — roughly $140 a month of
              after-tax return that never shows up in a cash-on-cash
              calculation. Whether the paper loss offsets your W-2 income
              depends on the $25,000 active-participation allowance and its
              income phase-out — the{" "}
              <Link
              ...
              traces that exact bridge line by line, and the{" "}
              <Link
              ...
              runs the after-tax math on your own numbers.
            </p>
            ...
            <p>
              ...
              pay them. <strong>Improvements</strong> — a new roof, an
              addition, a full kitchen renovation — are capitalized and start
              their <em>own</em> 27.5-year schedules from their in-service
              dates: a $12,000 roof in year three adds $436 a year, on its own
              clock, alongside the building&apos;s. And some components
              aren&apos;t 27.5-year property at all:{" "}
              <strong>appliances, carpet, and furniture recover over 5
              years; fences, driveways, and landscaping over 15</strong>. Two
              practical escape hatches keep small items out of the
            ...
            <p>
              ...
              by the depreciation that was <strong>allowed or
              allowable</strong> — the deductions you were <em>entitled</em>{" "}
              to, whether or not you claimed them. Skip depreciation for ten
              years on the duplex and you still owe{" "}
              <Link
              ...
              — at up to 25% — on roughly $70,000 of deductions you never
              took. Worst of both worlds: no annual benefit, full exit bill.
              If you&apos;ve been under-claiming, the repair is{" "}
              ...
              current year — one of the few genuinely retroactive fixes in
              the tax code, and well worth a CPA&apos;s fee. The same logic
              means depreciation belongs in your underwriting from day one:
              it&apos;s a real return stream while you hold and a real
              liability when you exit, and deals should be compared with both
              sides priced in. (Depreciation is also just one of the fourteen
              deductions on the schedule — the{" "}
              <Link
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Depreciating the purchase price instead of the
                basis.</strong> Leaving out capitalizable closing costs
                forfeits real deductions; leaving <em>in</em> the land invites
                an audit adjustment. Build basis first, split second.
              </li>
              <li>
                <strong>Guessing the land ratio.</strong> A 20%-vs-30% land
                assumption moves the deduction $931 a year on this duplex.
                Pull the assessor&apos;s actual split for your parcel — it
                takes five minutes and it&apos;s the number that survives
                scrutiny.
              </li>
              <li>
              ...
              <li>
                <strong>Capitalizing repairs (or expensing improvements).</strong>{" "}
              ...
              <li>
                <strong>Skipping depreciation to &quot;avoid recapture
                later.&quot;</strong> Recapture is computed on allowed{" "}
                <em>or allowable</em> depreciation — you pay it either way.
                Not claiming the deduction is pure loss.
              </li>
            </ul>
            ...
            <p>
              Depreciation is three steps of arithmetic sitting on one
              carefully built number: purchase price plus acquisition costs,
              minus the assessor&apos;s land share, divided by 27.5 — with a
              mid-month haircut in year one. On the worked duplex that&apos;s
              $6,982 a year, about $1,676 of tax shielded in a 24% bracket,
              and the difference between a property that pays you $2,400 and
              one that reports a loss. It&apos;s the quietest return stream in
              the deal, it compounds for the entire hold, and — thanks to
              allowed-or-allowable — it&apos;s the one deduction you can&apos;t
              afford to skip. Underwrite it like the cash flow it effectively
              is: run the full picture — price, rent, financing, taxes, and
              the after-tax return — through the{" "}
              <Link href="/" className="text-primary font-semibold hover:underline">
                TrueCap analyzer
              </Link>{" "}
              before you buy, so the deduction is part of the decision instead
              of a surprise on your first Schedule E. None of this is tax
              advice; recovery periods, safe harbors, and passive-loss rules
              have edge cases — confirm your specific situation with a CPA.
            </p>
          </div>
        </article>
      </main>

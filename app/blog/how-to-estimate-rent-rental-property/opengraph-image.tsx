/**
 * Dynamic OG image for the "how to estimate rent" post. Same design
...
export const alt = "How to estimate rent on a rental property — TrueCap";
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>
            Rent comps · GRM check · 1% rule · vacancy · DSCR
          </div>

        ...
        <article>
          ...
          <header className="mb-8">
            ...
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              Schedule E is where your rental&apos;s tax story gets told — and
              it tells a different story than your bank account. A property that
              puts $139 a month in your pocket can report a $3,703 loss to the
              IRS, legally, in the same year. Here&apos;s every line that
              matters, a complete worked example, and the loss rules that decide
              whether that paper loss saves you money this April or waits in a
              carryforward.
            </p>
          </header>
          ...
          <div className="prose prose-neutral max-w-none text-foreground space-y-6 leading-relaxed">
            ...
            <p>
              ...
              rental real estate. One column per property, up to three per form,
              with overflow onto additional copies. For most buy-and-hold
              landlords it&apos;s the only place a rental touches the tax return
              — no self-employment tax, no Schedule C, unless you&apos;re
            ...
            <p>
              ...
              nor your NOI. Three wedges separate them. Depreciation is a
              deduction you never wrote a check for this year. Mortgage
              principal is a check you wrote that isn&apos;t deductible. And
              capital improvements are checks you wrote that deduct slowly, over
              27.5 years, instead of when you paid them. Keep those three in
              view and the form stops being mysterious. It&apos;s also not just
              a tax document — when you apply for your next conventional loan,
              the underwriter will pull your Schedule E to calculate the
              property&apos;s qualifying income, so sloppy categorization
              follows you into your next purchase (DSCR lenders are the
              exception;{" "}
              <Link
            ...
            <p>
              Before the money lines, Schedule E asks for the property address,
              a type code (1 for single-family, 2 for multi-family, 3 for
              vacation/short-term, and so on), and two day counts:{" "}
              <strong>fair rental days</strong> and{" "}
              <strong>personal use days</strong>. For a pure rental, fair rental
              days is the number of days the property was rented or available at
              market rent — 365 for a full-year rental, fewer if you bought
              mid-year. Personal use days matter because more than 14 days of
              personal use (or 10% of rental days, if greater) reclassifies the
              property as a mixed-use residence and forces you to prorate every
              expense. House-hackers renting out units of a duplex they live in
              split the building: the rented unit&apos;s share goes on Schedule
            ...
            <p>
              Line 3 is gross rent actually collected during the year — not the
              lease amount, not scheduled rent. A few items that belong here and
              get missed: prepaid rent counts in the year you receive it
              (January&apos;s rent paid December 28 is this year&apos;s income),
              a security deposit you kept for damages or unpaid rent becomes
              income when you keep it (a deposit you&apos;ll return is not
              income), and tenant-paid expenses in lieu of rent — the tenant who
              covers a $400 plumbing bill off the rent — count as both income on
              line 3 and a deduction on the matching expense line. If a tenant
              simply didn&apos;t pay, there&apos;s no &quot;bad debt&quot;
              deduction for cash-basis landlords: the rent never entered income,
              so it can&apos;t be deducted out.
            </p>
            ...
            <p>
              Nineteen expense categories, but on a typical single-family rental
              about seven carry the weight:
            </p>
            <ul>
              <li>
              ...
              <li>
                ...
                in its current condition. The repair-vs-improvement boundary is
                the most audited line on the form — more below.
              </li>
              <li>
            ...
            <p>
              ...
              catch-all on line 19 (HOA dues, software, bank fees, education) —
              are real money but may have less effect on the modeled operating
              result. The complete list of what&apos;s deductible, with the edge
              cases, is in{" "}
              <Link
            ...
            <p>
              ...
              <strong>27.5 years, straight-line</strong>. The mechanics: take
              your purchase price plus closing costs that attach to the property
              (title fees, recording, transfer taxes — see{" "}
              <Link
            ...
            <p>
              On a $250,000 purchase with $50,000 of land value, the depreciable
              basis is $200,000 and the annual deduction is{" "}
              <strong>$7,273</strong> ($200,000 ÷ 27.5). That&apos;s $606 a
              month of deduction with zero cash leaving your account — for most
              leveraged rentals, it&apos;s the difference between a taxable
              profit and a paper loss. Two caveats: the first and last years are
              prorated by month (mid-month convention), and every dollar you
              deduct reduces your basis, setting up depreciation recapture —
              taxed at up to 25% — when you sell. That bill can be deferred
              indefinitely with a{" "}
              <Link
            ...
            <p>
              A $250,000 single-family renting for $2,100/month, bought January
              2 with 25% down. Loan: $187,500 at 7% over 30 years — P&amp;I of
              $1,247/month, of which year-one interest is about $13,064 (the
              other $1,905 is principal). Land value $50,000, so depreciable
              basis is $200,000. Tenant pays utilities. The Schedule E column:
            </p>
            <ul>
              <li>
            ...
            <p>
              ...
              depreciation), so NOI is $16,634. Debt service was $14,969. Actual
              cash flow:{" "}
              <strong>+$1,665 for the year, about +$139/month</strong>, with a
              DSCR of 1.11. Same property, same year:{" "}
              <strong>+$139/month in the bank, −$3,703 to the IRS</strong>. The
              bridge is exact: cash flow ($1,665) plus principal paydown
            ...
            <p>
              ...
              Rental losses are <strong>passive</strong> by default, deductible
              only against passive income — unless you qualify for the{" "}
              <strong>$25,000 active participation allowance</strong>. Actively
              participate (approve tenants, set rents, authorize repairs — a
              property manager doesn&apos;t disqualify you, as long as you make
              the calls) and keep modified AGI at $100,000 or below, and you can
              deduct up to $25,000 of rental losses against your W-2 and other
              ordinary income. The allowance phases out fifty cents per dollar
              of MAGI above $100,000, reaching zero at $150,000.
            </p>
            <p>
              ...
              after-tax yield the cash-flow statement never shows. A household
              at $160,000 MAGI deducts nothing this year; the $3,703 becomes a{" "}
              <strong>suspended loss</strong> on Form 8582 that carries forward
              indefinitely, releasing against future rental income or, in full,
              when the property sells. Suspended losses aren&apos;t wasted —
              they&apos;re deferred. (Real estate professional status — 750+
              hours and more than half your working time in real estate —
              removes the passive limitation entirely, but W-2 earners rarely
              qualify.)
            </p>
            ...
            <p>
              Whatever survives the loss limits lands on line 26 of Schedule E,
              flows to Schedule 1, and from there onto your Form 1040 — added to
              (or subtracted from) your wages and everything else. Two practical
              implications. First, rental income is not subject to
              self-employment tax, which is a structural advantage over most
              side income: a dollar of rental profit keeps the 15.3% that a
              dollar of freelance profit gives up. Second, because the loss
              allowance phases out on <em>modified</em> AGI, a raise, a bonus,
              or a big capital gain in the same year can silently convert a
              deductible rental loss into a suspended one. If you&apos;re
              hovering near the $100,000 line, timing a deductible repair into a
              low-income year is worth a conversation with your CPA. And keep
              the depreciation schedule itself — Form 4562 in year one, your
              preparer&apos;s carryforward schedule after that. When you sell,
              the cumulative depreciation number on that schedule is what
              recapture is computed from, and reconstructing it ten years later
              from old returns is an afternoon you don&apos;t want.
            </p>
            ...
            <p>
              <strong>Deducting capital improvements as repairs.</strong> The
              $11,000 roof on line 14 is the classic audit flag. Whole roofs,
              HVAC systems, and kitchen remodels are improvements: capitalized,
              depreciated over 27.5 years (about $400/year for that roof, not
              $11,000 once). The dividing line and the $2,500 de minimis safe
              harbor are covered in the{" "}
              <Link
              ...
              . Underwriting note: this is also why a seller&apos;s Schedule E
              is weak due diligence — heavy line-14 years might be deferred
              maintenance catching up, or might be improvements misfiled.
            </p>
            <p>
              <strong>Deducting the full mortgage payment.</strong> Only
              interest is deductible. Writing off the $14,969 of total P&amp;I
              instead of the $13,064 of interest overstates deductions by $1,905
              in year one — and the gap widens every year as the payment shifts
              toward principal.
            </p>
            <p>
              <strong>Skipping depreciation to dodge recapture.</strong>{" "}
              Recapture applies to depreciation &quot;allowed or allowable&quot;
              — you pay it at sale whether or not you took the deduction.
              Skipping it is pure loss. (Missed years are fixable with a Form
              3115 catch-up.)
            </p>
            <p>
              <strong>Forgetting suspended losses at sale.</strong> Years of
              carryforwards on Form 8582 all release in the year you sell.
              Investors who switch preparers or self-file routinely lose track
              of five figures of suspended losses that should have offset the
              gain.
            </p>
            ...
            <p>
              ...
              repair-vs-improvement boundary and passive loss planning. But the
              structure of Schedule E is exactly why after-tax return and

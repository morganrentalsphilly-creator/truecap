/**
 * Dynamic OG image for the "break-even occupancy" post. Same design
...
export const alt = "Break-even occupancy for rental property — TrueCap";
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            How much vacancy can your rental survive?
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Break-even occupancy · break-even rent · the DSCR 1.0 line
          </div>

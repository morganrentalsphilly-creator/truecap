/**
 * Dynamic OG image for /blog/how-to-calculate-cash-on-cash-return. Auto-detected by the
...
export const alt = "How to calculate cash-on-cash return on a rental property — 2026 guide — TrueCap";
...
export default function Image() {
  return renderBlogOgImage({
    ...
    subline: "Formula · worked examples · common mistakes",
  });
}

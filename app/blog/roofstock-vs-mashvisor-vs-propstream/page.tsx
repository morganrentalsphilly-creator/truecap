      ...
      <main id="main" className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <article>
          ...
          <div className="prose prose-neutral max-w-none prose-headings:font-extrabold prose-headings:text-foreground prose-p:text-foreground prose-p:leading-relaxed prose-a:text-primary prose-a:no-underline hover:prose-a:underline prose-strong:text-foreground prose-li:text-foreground prose-li:leading-relaxed">
            ...
            <div
              dangerouslySetInnerHTML={{
                __html: `<p>None of the three calculates whether a specific property actually cash flows under your assumptions. They surface deals; you still have to underwrite them.</p>
            ...
            <p>
              However you source deals — turnkey marketplace, market heatmap, or
              off-market list — run them through TrueCap before you offer. 60
              seconds, free, no signup. The deal you didn&apos;t buy because the

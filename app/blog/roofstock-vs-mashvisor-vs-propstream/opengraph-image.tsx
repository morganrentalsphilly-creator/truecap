/**
 * Dynamic OG image for /blog/roofstock-vs-mashvisor-vs-propstream. Auto-detected by the
...
export const alt = "Roofstock vs Mashvisor vs PropStream: 3-way deal discovery comparison — TrueCap";

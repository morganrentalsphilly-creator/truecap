/**
 * Dynamic OG image for the "buying a rental with tenants in place" post.
...
export const alt = "Buying a rental property with tenants in place — TrueCap";
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>
            Estoppels · Deposit transfer · Loss-to-lease math · 2026
          </div>

...
export default function BlogPost() {
  ...
  const howToLd = {
    ...
    description:
      "Four-step process: compute NOI, compute annual debt service, divide, compare to lender minimum.",
    step: [
      {
        "@type": "HowToStep",
        name: "Compute NOI",
        text: "Gross rent minus vacancy minus all operating expenses. Excludes mortgage payment.",
      },
      {
        "@type": "HowToStep",
        name: "Compute annual debt service",
        text: "Monthly P&I × 12. Some lenders include taxes and insurance (PITIA).",
      },
      {
        "@type": "HowToStep",
        name: "Divide NOI by debt service",
        text: "Result is DSCR. Express to 2 decimals.",
      },
      {
        "@type": "HowToStep",
        name: "Compare with the written program",
        text: "Confirm the lender's current formula, minimum, rent evidence, leverage, and pricing; modeled DSCR does not guarantee approval or a rate tier.",
      },
    ],
  };
      ...
      <main id="main" className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <header className="mb-8 sm:mb-10">
          ...
          <p className="text-base sm:text-lg text-muted-foreground mt-4 leading-relaxed">
            DSCR = NOI ÷ annual debt service. It&apos;s the metric DSCR lenders
            use to qualify your loan. Here&apos;s the formula, what lenders
            include and exclude, three worked examples, and the difference
            between your DSCR and the lender&apos;s DSCR (which is usually
            lower).
          </p>
        </header>
        ...
        <article className="prose prose-slate max-w-none [&_p]:leading-relaxed [&_p]:text-foreground [&_h2]:font-extrabold [&_h2]:text-foreground [&_h2]:mt-10 [&_h2]:mb-3 [&_h3]:font-bold [&_h3]:text-foreground [&_h3]:mt-6 [&_h3]:mb-2 [&_li]:text-foreground [&_li]:leading-relaxed [&_strong]:text-foreground">
          ...
          <p>
            ...
            earns enough to cover its own mortgage. A DSCR of 1.25 means the
            property earns $1.25 of NOI for every $1.00 of debt service — a 25%
            safety margin. DSCR loans (the non-QM product class) qualify your
            loan based on this ratio instead of your personal income.
          </p>
          <p>
          ...
          <p>
            ...
            utilities you pay, HOA). NOT including mortgage. Full walkthrough in
            <Link
          ...
          <p>
            Monthly principal + interest payment × 12. Some DSCR lenders use
            PITIA (principal + interest + taxes + insurance + association dues)
            instead — check before locking. This matters because PITIA is
            meaningfully larger than P&amp;I and pushes DSCR lower.
          </p>
          ...
          <p>
            Confirm the specific program&apos;s current formula, minimum, rent
            evidence, leverage, pricing, reserves, and other eligibility rules
            in writing. A modeled DSCR does not guarantee approval or a
            particular rate tier.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>NOI:</strong> $12,540
            </li>
            <li>Loan: $150K at 7.5% / 30 yr = $1,049/mo P&amp;I</li>
            <li>Annual debt service (P&amp;I only): $12,588</li>
            <li>
              <strong>DSCR (P&amp;I basis):</strong> $12,540 ÷ $12,588 ={" "}
              <strong>1.00</strong>
            </li>
          </ul>
          <p>
            Right at 1.0 — comfortable for a sub-1.0 product, marginal for a
            standard 1.25 program. Most investors target 1.25+ to avoid being a
            borderline case if the appraised rent comes in below your number.
          </p>
          ...
          <p>
            Same property, but now the lender uses PITIA. Property tax $3,000,
            insurance $1,200 (both already in operating expenses but the lender
            double-dips here for safety).
          </p>
          <ul>
            ...
            <li>
              <strong>DSCR (PITIA basis):</strong> $12,540 ÷ $16,788 ={" "}
              <strong>0.75</strong>
            </li>
          </ul>
          <p>
            Same property, but the PITIA-basis DSCR is 0.75 — well below any
            DSCR program&apos;s minimum. This is why it&apos;s critical to ask
            the lender which methodology they use before running your numbers.
            P&amp;I basis is more common; PITIA basis is stricter and used by
          ...
          <p>
            $200K property in higher-cap market, $2,200/mo rent, 25% down at
            7.5%.
          </p>
          <ul>
            ...
            <li>
              <strong>DSCR:</strong> $14,520 ÷ $12,588 = <strong>1.15</strong>
            </li>
          </ul>
          <p>
            1.15 clears a 1.0-minimum program comfortably and qualifies for
            sub-1.25-tier pricing. If you can push rent another $150/mo or shave
            10% off operating expenses, you cross 1.25 and unlock the better
            rate tier — often worth 25-50 basis points on the rate over 30
            years.
          </p>
          ...
          <ul>
            <li>
              <strong>Appraisal or program rent &lt; your rent.</strong> Some
              programs use an appraisal rent form or other specified evidence.
              Ask which lease or appraisal rent the program accepts and test any
              supported downside.
            </li>
            <li>
              <strong>PITIA vs P&amp;I.</strong> If you computed on P&amp;I and
              the lender uses PITIA, recompute with the exact taxes, insurance,
              and association dues.
            </li>
            <li>
              <strong>Lender-imposed vacancy / management add-back.</strong>
              Ask whether and how the program applies vacancy, management, or
              other adjustments.
            </li>
          </ul>
          <p>
            Ask the lender exactly which methodology and evidence it uses, then
            reproduce that calculation separately from your operating model.
            Choose a downside cushion based on the property and written program
          ...
          <ul>
            <li>
              <strong>Base case</strong> with your rent and rate.
            </li>
            <li>
              <strong>Supported rent is lower</strong> — test a meaningful
              downside based on the available evidence.
            </li>
            <li>
              <strong>Rate or costs increase</strong> — test the written
              quote&apos;s expiration and a realistic pre-lock downside.
            </li>
          </ul>
          <p>
            If all three pencil, the scenario has more modeled cushion; it still
            does not establish approval. If only the base case works, you have
            little modeled margin for surprises that happen on every other
            closing.
          </p>
        ...
        <footer className="mt-12 pt-8 border-t border-border">
          <p className="text-sm text-muted-foreground leading-relaxed">
            TrueCap computes DSCR live as you type — P&amp;I and PITIA both —
            alongside cap rate, cash flow, and a stress-test grid for
            appraised-rent and rate sensitivities. Lender-facing numbers before
            you make the call.{" "}
          </p>
        </footer>
      </main>

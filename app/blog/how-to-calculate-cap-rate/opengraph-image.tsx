/**
 * Dynamic OG image for /blog/how-to-calculate-cap-rate. Auto-detected by the
...
export const alt = "How to calculate cap rate (with worked examples) — 2026 guide — TrueCap";

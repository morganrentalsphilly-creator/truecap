    ...
    <div className="min-h-screen bg-background">
      ...
      <main id="main" className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <article className="prose prose-slate max-w-none [&_p]:leading-relaxed [&_p]:text-foreground [&_h2]:font-extrabold [&_h2]:text-foreground [&_h2]:mt-10 [&_h2]:mb-3 [&_h3]:font-bold [&_h3]:text-foreground [&_h3]:mt-6 [&_h3]:mb-2 [&_li]:text-foreground [&_li]:leading-relaxed [&_strong]:text-foreground">
          ...
          <p>
            Monthly market rent × 12. Use the actual lease rent if the property
            is currently rented; use comparable-property market rent if vacant.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Utilities you pay</strong> (water, trash, sewer in many
              areas; everything for multi-family common areas).
            </li>
            <li>
              <strong>HOA fees</strong>, lawn/snow service, pest control.
            </li>
          </ul>
          <p>
            <strong>NOT</strong> in operating expenses: mortgage principal,
            mortgage interest, depreciation, income tax, or the CapEx reserve.
            Under the lender/appraiser-style convention TrueCap uses, CapEx is a
            below-NOI capital reserve. Still subtract a realistic reserve (often
            modeled around 5-10% of rent or from a component schedule) before
          ...
          <p>
            NOI ÷ purchase price = cap rate. Multiply by 100 to express as a
            percentage.
          </p>
          ...
          <ul>
            <li>
              Gross rent: $2,400 × 12 = <strong>$28,800</strong>
            </li>
            ...
            <li>
              <strong>NOI:</strong> $27,072 − $11,166 = <strong>$15,906</strong>
            </li>
            <li>
              <strong>Cap rate:</strong> $15,906 ÷ $300,000 ={" "}
              <strong>5.3%</strong>
            </li>
            <li>CapEx reserve (below NOI): −$3,000</li>
            <li>
              Cash after CapEx, before debt: <strong>$12,906</strong>
            </li>
          </ul>
          <p>
          ...
          <ul>
            ...
            <li>
              Broker&apos;s cap rate: $24,000 ÷ $300,000 = <strong>8%</strong>
            </li>
          </ul>
          <p>
          ...
          <p>
            Cap rate is identical regardless of financing — that&apos;s the
            whole point of using NOI (pre-debt service). A cash buyer of the
            property in example #1 gets the same 5.3% cap rate as a buyer using
            75% leverage. Their cash-on-cash returns are very different; their
            cap rates are the same.
          </p>
          <p>
            This is why cap rate is the metric to use when comparing
            <em> properties</em>, and cash-on-cash is the metric to use when
            comparing <em> investments</em> (since financing is part of an
            investment decision but not part of a property&apos;s intrinsic
            yield).
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              reported in listings often use unrealistically high projected
            ...
            <li>
              <strong>House hacks.</strong> When you live in one unit, the
              &ldquo;cap rate&rdquo; calculation is meaningless — use net

/**
 * Dynamic OG image for the vacancy rate post. Same design language as
...
export const alt = "Vacancy rate for rentals — TrueCap";
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>
            Physical vs economic · turnover math · DSCR impact
          </div>

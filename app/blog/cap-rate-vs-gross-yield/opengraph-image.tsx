/**
 * Dynamic OG image for the "Cap rate vs gross yield vs GRM" post.
 * Same design language as the other anchor posts.
 */

import { ImageResponse } from "next/og";

export const runtime = "edge";
export const alt = "Cap rate vs gross yield vs GRM for rental property — TrueCap";
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "48px 64px 0 64px", display: "flex" }}>
          ...
          >
            Cap rate vs gross yield vs GRM
          </div>
        </div>
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            Three quotes for the same building — which one to trust?
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Conversion table · Worked $250K duplex · The $54K twin trap
          </div>

      ...
      <main id="main" className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <article className="prose prose-slate max-w-none [&_p]:leading-relaxed [&_p]:text-foreground [&_h2]:font-extrabold [&_h2]:text-foreground [&_h2]:mt-10 [&_h2]:mb-3 [&_h3]:font-bold [&_h3]:text-foreground [&_h3]:mt-6 [&_h3]:mb-2 [&_li]:text-foreground [&_li]:leading-relaxed [&_strong]:text-foreground">
          <p>
            ...
            one difference is worth tens of thousands of dollars of hidden value
            on an ordinary deal. Sellers, agents, and listing sites switch
            between the three quotes freely, sometimes strategically, so knowing
            how to convert between them — and which one to trust at each stage
            of a deal — is a core underwriting skill. This post defines all
            three, works them on the same $250,000 duplex, gives you a
            conversion table, and shows the trap where two properties with
          ...
          <p>
            ...
            price has an 11.5% gross yield. No expenses, no vacancy, no
            financing — just rent over price.
          </p>
          <p>
            <strong>Gross rent multiplier (GRM)</strong> is the same fraction
            upside down: price divided by annual rent. That $250,000 property at
            $28,800 of rent is a GRM of 8.7 — the building costs 8.7 years of
            gross rent. Because they&apos;re reciprocals, every GRM maps to
          ...
          <p>
            ...
            which deducts operating expenses from rent before dividing by price.
          ...
          <p>
            The cap rate takes an expense budget. Underwrite it line by line: 5%
            vacancy ($1,440), property taxes at 1.5% of value ($3,750),
            insurance ($1,600), 8% maintenance ($2,304), 8% management ($2,304),
            and 5% capital reserves ($1,440). Total operating expenses:{" "}
            <strong>$12,838</strong>, a 44.6% expense ratio. That leaves NOI of
            $28,800 − $12,838 = <strong>$15,962</strong>, and a cap rate of
          ...
          <p>
            ...
            depths of the same income stream — and the spread between the 11.5%
          ...
          <p>
            ...
            1% rule is the 12%-gross / 8.3-GRM row, and the near-extinct 2% rule
            is the bottom row. (Both rules are the same rent-to-price screen at
            different bars — the{" "}
            <Link
          ...
          <p>
            ...
            identical twin one county over: same price, same $28,800 rent, same
            insurance, maintenance, management, vacancy. One difference — the
          ...
          <p>
            ...
            Capitalize that shortfall at Duplex A&apos;s 6.4% rate and Duplex B
            is worth roughly <strong>$196,000</strong>, not $250,000: a $54,000
            valuation gap that two &ldquo;identical&rdquo; gross yields cannot
            see. Taxes are the cleanest example, but the same trap hides in
            flood-zone insurance premiums, 40-year-old roofs that inflate the
            capex reserve, and self-managed listings whose pro formas omit
            management entirely.
          </p>
          ...
          <p>
            ...
            reality, the number appraisers and commercial lenders speak, and the
            only fair way to compare buildings across tax and insurance regimes
            — as the twin duplexes show. What counts as a good cap rate varies
          ...
          <p>
            ...
            &ldquo;8% yield&rdquo; on a turnkey listing is almost always quoting
            gross — which is roughly a 4% cap at normal expenses. If your buy
            box says &ldquo;6%,&rdquo; make sure both numbers live on the same
            side of the expense line before you conclude the deal clears it.
          </p>
          <p>
            <strong>Second: distrust pro-forma NOI.</strong> A quoted cap rate
            is only as honest as the expense budget under it. Listing pro formas
            routinely assume 5% vacancy in a soft market, zero management, and
            maintenance numbers from a fresh renovation. Rebuild NOI from your
            own line items — it takes ten minutes and it&apos;s where the
            twin-duplex gap gets caught.
          </p>
          <p>

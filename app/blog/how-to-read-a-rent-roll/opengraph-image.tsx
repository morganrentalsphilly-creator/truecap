/**
 * Dynamic OG image for the rent roll post. Same design language as the
 * other anchor posts.
 */
...
export const alt = "How to read a rent roll — TrueCap";
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            How to read a rent roll and verify a rental&apos;s income
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Potential vs collected · loss-to-lease · estoppels · 2026
          </div>

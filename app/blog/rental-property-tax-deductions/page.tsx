    ...
    <div className="min-h-screen bg-background">
      ...
      <main id="main" className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="prose prose-neutral max-w-none text-foreground space-y-6 leading-relaxed">
          <p>
            A note before we start: this is general education, not tax advice. Eligibility depends on your facts and the law for the relevant tax year. Use this as a checklist alongside current <a href="https://www.irs.gov/publications/p527" className="text-primary font-semibold hover:underline">IRS Publication 527</a> and <a href="https://www.irs.gov/publications/p925" className="text-primary font-semibold hover:underline">IRS Publication 925</a>, then confirm the filing treatment with a qualified tax professional.
          </p>
          ...
          <p>
            <strong>Illustrative example:</strong> a $300k, 30-year loan at 7% produces about $20,800 of interest during the first 12 payments. The allowable rental deduction may differ because of closing dates, points, mixed use, business-interest limits, or other adjustments. Use the lender&apos;s records and your actual amortization schedule. Interest is below the property&apos;s <Link href="/glossary/noi" className="text-primary font-semibold hover:underline">NOI</Link> line because NOI is computed before debt service.
          </p>
          ...
          <p>
            <strong>Illustrative example:</strong> if a supported allocation assigns $400k of a $500k purchase to the residential-rental building, simple division by 27.5 is about $14,545 per full year before conventions and other adjustments. That figure is a modeled deduction, not a guaranteed current tax saving. Passive-activity, basis, at-risk, and other limits can change when or whether it reduces tax. Use the <Link href="/tools/rental-property-tax-calculator" className="text-primary font-semibold hover:underline">rental property tax calculator</Link> only as an illustration to discuss with your adviser.
          </p>
          <p>
            <strong>Cost segregation.</strong> A defensible study may identify eligible components with shorter recovery periods than the residential building. The classification is fact-intensive, and the timing benefit depends on basis, acquisition and placed-in-service dates, bonus-depreciation eligibility, passive-loss limits, recapture, study cost, and the planned hold. There is no responsible universal property-price threshold or payback multiple. Compare the after-tax present value under adviser-reviewed scenarios and review the IRS <a href="https://www.irs.gov/businesses/small-businesses-self-employed/audit-techniques-guides-atgs" className="text-primary font-semibold hover:underline">Cost Segregation Audit Technique Guide</a> and <a href="https://www.irs.gov/publications/p946" className="text-primary font-semibold hover:underline">Publication 946</a>.
          </p>
          ...
          <p>
            <strong>Items often reviewed as repairs:</strong> limited roof patching, painting between tenants, a broken window, a localized plumbing fix, or a small fence repair. Scope and surrounding projects can change the classification.
          </p>
          <p>
            <strong>Items often reviewed as improvements:</strong> a full roof replacement, kitchen remodel, addition, HVAC replacement, or full re-piping. Recovery periods and elections depend on the component and facts.
          </p>
          <p>
          ...
          <p>
            Ordinary and necessary travel primarily to manage, conserve, or maintain a rental may be deductible, subject to allocation and substantiation. The optional business mileage rate can change, including within a year; use the <a href="https://www.irs.gov/tax-professionals/standard-mileage-rates" className="text-primary font-semibold hover:underline">IRS standard-mileage table</a> for the trip date.
          </p>
          <p>
          ...
          <p>
            A properly executed <Link href="/blog/1031-exchange-basics" className="text-primary font-semibold hover:underline">section 1031 exchange</Link> may defer recognized gain when strict eligibility, identification, timing, title, and reinvestment requirements are met. It defers rather than erases tax, and it is not a cure-all for every sale.
          </p>
          ...
          <p>
            (4) Use <Link href="/" className="text-primary font-semibold hover:underline">TrueCap</Link>&apos;s tax-impact output as an illustrative scenario. It does not determine eligibility, passive-loss treatment, filing position, or the advice a tax professional would give for your return.
          </p>
        </div>
        </article>
      </main>

/**
 * Dynamic OG image for the "negative leverage in real estate" post. Same
 * design language as the other anchor posts.
 */

import { ImageResponse } from "next/og";

export const runtime = "edge";
export const alt = "Negative leverage in real estate — TrueCap";
    ...
    (
      ...
      >
        ...
        <div style={{ padding: "26px 64px 0 64px", display: "flex" }}>
          ...
          >
            When borrowing lowers your return
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>
            Loan constant vs cap rate · the DSCR trap · 2026 math
          </div>

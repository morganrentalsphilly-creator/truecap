...
const MATRIX: Row[] = [
  ...
  { feature: "Cost to use",                       truecap: "Free to underwrite; Pro $19/mo for projections + share + PDF",          roofstock: "Free to browse; 0.5% buyer fee at close (typically $1k–$3k)",      winner: "truecap" },
  ...
  { feature: "Deal score with breakdown",           truecap: "Pro — 0-100 with subscore drill-down",                                    roofstock: "Curated 'Neighborhood Rating' (qualitative)",                       winner: "truecap" },
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        underwrite and $19/month for Pro features. They&apos;re not
    ...
    plainTextAnswer:
      "Roofstock charges 0.5% buyer marketplace fee at close (~$1,000 on a $200k property). TrueCap is free to underwrite, $19/month for Pro. Not substitutes — Roofstock fee buys you a brokered transaction, TrueCap subscription gives you the analytical tools.",
  },
  {

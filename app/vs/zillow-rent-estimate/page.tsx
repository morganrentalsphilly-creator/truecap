    ...
    <div className="min-h-screen bg-background">
      ...
      <main id="main" className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-12 sm:mb-16 rounded-2xl border border-amber-500/30 bg-amber-50/30 p-6 sm:p-8">
          <h2 className="text-xl sm:text-2xl font-black text-foreground mb-3">Why Zillow Rent estimates are unreliable</h2>
        ...
        <section className="mb-12 sm:mb-16 rounded-2xl bg-primary p-6 sm:p-8 text-primary-foreground">
          <h2 className="text-2xl sm:text-3xl font-black mb-2">Investor-grade rent estimates, free.</h2>

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/home.jpg", width: 1200, height: 630, alt: "TrueCap 2% rule calculator" }],
  },
  twitter: {
...
export default function TwoPercentRuleCalculatorPage() {
  ...
  return (
    <>
      <ToolBreadcrumbSchema toolPath="/tools/2-percent-rule-calculator" toolName="2% rule calculator" />
      <script
        ...
        <main id="main" className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          ...
          <header className="mb-6 sm:mb-8">
            ...
            <p className="text-base sm:text-lg text-muted-foreground mt-2 leading-relaxed">
              ...
              purchase price? Type in price and rent — the ratio computes
              live, judged against both the 2% and 1% bars.
            </p>
          </header>
          ...
          <article className="prose prose-slate max-w-none mt-10 sm:mt-12 [&_p]:leading-relaxed [&_p]:text-foreground [&_h2]:font-extrabold [&_h2]:text-foreground [&_h2]:mt-10 [&_h2]:mb-3 [&_h3]:font-bold [&_h3]:text-foreground [&_h3]:mt-6 [&_h3]:mb-2 [&_li]:text-foreground">
            ...
            <p>
              The 2% rule is the strict sibling of the better-known 1%
              rule. It says a rental property should generate monthly rent
              equal to at least 2% of its purchase price:
            </p>
            ...
            <p>
              Like the 1% rule, it&apos;s pure triage — gross rent over
              price, no expenses, no financing. Unlike the 1% rule, the
              bar is high enough in 2026 that the properties clearing it
              deserve suspicion before celebration.
            </p>
            ...
            <p>
              The 2% rule dates from an era when workforce housing in
              Midwest cash-flow markets sold cheaply enough that
              $50&ndash;60k houses rented for $1,000&ndash;1,200/month.
              At those numbers the ratio was achievable in decent
              neighborhoods. A decade-plus of price appreciation without
              proportional rent growth moved the mainstream screening bar
              down to 1% — which is why the{" "}
              <Link href="/tools/1-percent-rule-calculator" className="text-primary font-semibold hover:underline">1% rule calculator</Link>{" "}
              is the practical first filter today, and the{" "}
              <Link href="/blog/1-percent-rule-rental-property" className="text-primary font-semibold hover:underline">1% rule guide</Link>{" "}
              covers how to read it by market type.
            </p>
            <p>
              Realistically, very few US properties hit 2% in 2026. Most
              that do sit in distressed neighborhoods where the management
              reality — turnover, collections, vacancy, repair burden —
              consumes the cash flow the ratio promises. The ratio is
              telling you about the neighborhood as much as the deal.
            </p>
            ...
            <ul>
              <li>
                ...
                property (where the rule isn&apos;t the point) or an
                overpriced rental. Decide which before moving on.
              </li>
              <li>
                <strong>1.0&ndash;1.5%</strong>{" "}— strong screening
                territory in cash-flow markets. Worth the full underwrite.
              </li>
              <li>
                <strong>1.5&ndash;2%</strong>{" "}— exceptional on paper.
                Check the rent comp first: above-market rent on the
                listing is the most common way a mediocre deal fakes this
                band.
              </li>
              <li>
                <strong>2%+</strong>{" "}— investigate the discount. What do
                buyers know that the listing doesn&apos;t say? Deferred
                maintenance, insurance problems, tax quirks, and declining
                demand all live here.
              </li>
            </ul>
            <p>
              The same logic applies to unusually high cap rates — a
              theme our guide to{" "}
              <Link href="/blog/what-is-a-good-cap-rate" className="text-primary font-semibold hover:underline">what counts as a good cap rate</Link>{" "}
              covers: high yield prices in high risk. No rent-to-price
            ...
            <h3>Expenses</h3>
            <p>
              Gross rent over price says nothing about property tax,
            ...
            <p>
              A ratio computed on the current tenant&apos;s above-market
              rent, or on an optimistic pro-forma, isn&apos;t a 2% deal —
              it&apos;s a 1.4% deal wearing makeup. Verify what similar
              units actually lease for before trusting the numerator.
            </p>
            <h3>The building itself</h3>
            <p>
              Cheap buildings are cheap for reasons that arrive as CapEx:
              roofs, electrical service, plumbing stacks. A 2% ratio on a
              building with a five-figure repair backlog is a financing
              plan for the backlog, not a return.
            </p>

            <h2 className="text-2xl sm:text-3xl">From screen to underwrite</h2>
            <p>
              Rules of thumb earn a deal a closer look; they never close
              the loop. When a property clears whatever bar your market
              supports, run the real numbers: actual tax bill, real
              insurance quote, verified rent comps, and the full return
              stack — cash flow,{" "}
              ...
              in about two minutes, auto-filling state property tax and a
              HUD rent benchmark so the screen&apos;s guesses get replaced,
              not repeated.
            </p>
          ...
          <section className="mt-10 sm:mt-12 rounded-2xl bg-primary text-primary-foreground p-6 sm:p-8">
            ...
            <p className="text-sm sm:text-base opacity-90 mb-4">
              A 2% ratio is a prompt to investigate, and investigation
              means real numbers. TrueCap runs the full underwrite —
              expenses itemized, financing modeled, verdict in plain
              English — from the same price and rent you typed here.
            </p>

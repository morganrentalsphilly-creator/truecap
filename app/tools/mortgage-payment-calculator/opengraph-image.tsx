/**
 * Dynamic OG image for /tools/mortgage-payment-calculator. Auto-detected by Next.js
...
export const alt = "Mortgage payment calculator — TrueCap";
...
export default function Image() {
  return renderToolOgImage({
    ...
    tagline: "Full PITI breakdown — principal, interest, taxes, insurance. Investment-property rate context.",
  });
}

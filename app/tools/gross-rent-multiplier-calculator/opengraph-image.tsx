/**
 * Dynamic OG image for /tools/gross-rent-multiplier-calculator. Auto-detected by Next.js
...
export default function Image() {
  return renderToolOgImage({
    name: "GRM calculator",
    tagline: "Property price ÷ annual gross rent. The 10-second screening ratio for triaging deals before underwriting.",
  });
}

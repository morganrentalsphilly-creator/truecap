/**
 * Dynamic OG image for /tools/house-hacking-calculator. Auto-detected by
...
export const alt = "House hacking calculator — TrueCap";
...
export default function Image() {
  return renderToolOgImage({
    ...
    tagline: "Live in one unit, rent the rest. PITI minus tenant rent = your effective housing cost — plus the honest after-reserves number.",
  });
}

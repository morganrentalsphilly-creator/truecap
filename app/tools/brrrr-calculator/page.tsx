        ...
        >
          <header className="mb-6 sm:mb-8">
            ...
            <p className="text-base sm:text-lg text-muted-foreground mt-2 leading-relaxed">
              ...
              before you commit — see how much of your capital you&apos;ll get
              back, and whether the post-refi rent still cash-flows.
            </p>
          </header>
          ...
          <article className="prose prose-slate max-w-none mt-10 sm:mt-12 [&_p]:leading-relaxed [&_p]:text-foreground [&_h2]:font-extrabold [&_h2]:text-foreground [&_h2]:mt-10 [&_h2]:mb-3 [&_h3]:font-bold [&_h3]:text-foreground [&_h3]:mt-6 [&_h3]:mb-2 [&_li]:text-foreground">
            ...
            <p>
              ...
              payment for every property — a 20% down requirement on a $250k
              house is $50k of cash, every time — BRRRR investors recycle the
              same capital across multiple properties by buying under market,
              forcing appreciation through rehab, refinancing based on the new
              value, and pulling most of the original capital back out. Review
              the{" "}
              <Link
                href="/blog/brrrr-method-explained"
                className="text-primary font-semibold hover:underline"
              >
                BRRRR sequence and assumptions
              </Link>{" "}
              before maintaining a complete project ledger outside this
            ...
            <h3>Buy</h3>
            <p>
              The deal is made or lost here. BRRRRs need to be purchased under
              market — typically through off-market channels (direct mail,
              wholesalers, foreclosure auctions). On-market MLS deals rarely
              have enough room for a successful BRRRR.
            </p>
            <h3>Rehab</h3>
            <p>
              The rehab forces equity. Your rehab needs to deliver enough ARV
              bump to make the refi math work. Track every expense. Set a
              contingency from scope, inspections, bids, property age, and
              downside cases rather than assuming one percentage fits every
              project.
            </p>
            <h3>Rent</h3>
            <p>
              ...
              lender&apos;s rent, coverage, eligibility, approval, or whether
              any capital is returned.
            </p>
            <h3>Refinance</h3>
            <p>
            ...
            <h2 className="text-2xl sm:text-3xl">
              What &ldquo;infinite return&rdquo; means
            </h2>
            <p>
              If your refi pulls all your invested cash back out, you own a
              cash-flowing property with $0 of your money in it. Annual cash
              flow ÷ $0 = infinite return. That&apos;s the BRRRR holy grail.
            </p>
            <p>
              In practice, most BRRRRs leave $5-15k in the deal. That&apos;s
              still a great outcome — recycling 80-95% of your capital lets you
              scale 5-10× faster than traditional buy-and-hold.
            </p>

            <h2 className="text-2xl sm:text-3xl">Common BRRRR mistakes</h2>
            <h3>Optimistic ARV</h3>
            <p>
              The single most common BRRRR failure: the appraisal comes in below
              your assumed ARV, the refi loan is smaller than expected, and more
              of your capital is trapped. Always use recent sold comps, not
              Zestimates or active listings.
            </p>
            ...
            <p>
              ...
              walks through per-sq-ft benchmarks and the line items that most
              often blow budgets.
            </p>
            <h3>Ignoring carrying costs</h3>
            <p>
              From close to refi, you&apos;re paying mortgage, taxes, insurance,
              and utilities with no rent coming in. Six months of carrying costs
              can be $5-10k. Forgetting this in the budget leaves you short at
              the refi.
            </p>
            <h3>Refi rate shock</h3>
            <p>
              Rates change. The 6.5% you underwrote for the refi might be 7.5%
              when you actually close. Stress-test your post-refi cash flow at a
              1pp higher rate. For the deeper refi math (DSCR, LTV, cash-out
              timing), see our walkthrough on{" "}
              <Link
          ...
          <section className="mt-10 sm:mt-12 rounded-2xl bg-primary text-primary-foreground p-6 sm:p-8">
            <h2 className="text-xl sm:text-2xl font-extrabold mb-2">
              BRRRRs deserve a saved pipeline
            </h2>
            <p className="text-sm sm:text-base opacity-90 mb-4">
              Running ten BRRRRs to find one that works? TrueCap saves every
              analysis, compares them side by side, and exports the best ones as
              one-page PDFs to share with your lender.
            </p>

/**
 * Dynamic OG image for /tools/50-percent-rule-calculator. Auto-detected
...
export const alt = "50% rule calculator — TrueCap";
...
export default function Image() {
  return renderToolOgImage({
    ...
    tagline: "Operating expenses ≈ half of gross rent. The 3-second expense triage — with an honest ratio for the markets where 50% lies.",
  });
}

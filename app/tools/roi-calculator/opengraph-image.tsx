/**
 * Dynamic OG image for /tools/roi-calculator. Auto-detected by Next.js
...
export const alt = "Rental property ROI calculator — TrueCap";
...
export default function Image() {
  return renderToolOgImage({
    ...
    tagline: "Cash flow + principal paydown + appreciation — the real total return on a rental, not just one piece of it.",
  });
}

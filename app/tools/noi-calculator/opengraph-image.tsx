/**
 * Dynamic OG image for /tools/noi-calculator. Auto-detected by Next.js
...
export const alt = "NOI calculator — TrueCap";
...
export default function Image() {
  return renderToolOgImage({
    name: "NOI calculator",
    tagline: "Net Operating Income with every common opex line + vacancy + the operating-expense ratio.",
  });
}

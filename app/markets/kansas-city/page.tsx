...
export default function KansasCityMarketPage() {
  ...
  const benchmark = getCapRateBenchmark("Kansas City, MO");
    ...
    <div className="min-h-screen bg-background">
      ...
      <main id="main" className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-10 rounded-2xl border border-[var(--brand-orange)]/25 bg-[var(--brand-orange-light)] p-5 sm:p-6">
          <h2 className="text-base font-extrabold uppercase tracking-widest text-[var(--brand-orange)] mb-2">Jackson County tax reassessment notice</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-extrabold text-foreground mb-4">Frequently asked — Kansas City investing</h2>
        ...
        <section className="mb-10 rounded-2xl bg-primary p-6 sm:p-8 text-primary-foreground">
          <h2 className="text-xl sm:text-2xl font-extrabold mb-2">Run your next Kansas City deal in 60 seconds</h2>

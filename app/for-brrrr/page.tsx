      ...
      <main id="main" className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-12 sm:mb-16">
          ...
          <div className="mt-7 flex flex-col items-stretch gap-3 sm:flex-row sm:items-center">
            {/* Deep-link into the analyzer with the BRRRR play pre-selected
                (?strategy= analyzer handoff) — a BRRRR operator shouldn't
                land on a blank buy-and-hold form. */}
            <Link
              href="/?strategy=brrrr#main"
              prefetch={false}

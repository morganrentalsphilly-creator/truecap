...
const ALL_CALCULATORS: CalculatorEntry[] = [
  ...
  { slug: "arv-calculator", title: "ARV Calculator (After-Repair Value + 70% Rule)", shortTitle: "ARV", description: "Estimate after-repair value from entered renovated comps and calculate an early 70%-rule price screen screen.", category: "offer", embeddable: true },

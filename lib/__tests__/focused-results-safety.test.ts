...
describe("focused decision safety", () => {
  it("never reveals the price-ceiling number without entitlement or sample preview", () => {
    ...
    expect(summary).not.toContain("Negotiate to ${money(offerCeiling.ceiling)} or less — or pass");
    expect(summary).toContain("above the Offer Ceiling under the selected rules");

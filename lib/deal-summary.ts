...
export const DEAL_SUMMARY_SYSTEM_PROMPT = [
  ...
  "- The Offer Ceiling is the highest price that still meets the user's targets under the assumptions shown, not a recommended offer. Never direct the user to make, submit, or avoid an offer; say to verify rent, financing, taxes, insurance, property condition, and material costs before acting.",

...
export const ASSUMPTION_META: Record<string, AssumptionMeta> = {
  rent: { source: "HUD Fair Market Rent", confidence: "medium", verify: "Check live rent comps for this exact address." },
  interestRate: { source: "FRED 30-yr average", confidence: "high", verify: "Lock your actual lender quote." },
  ...
  propertyTaxPct: { source: "State effective rate", confidence: "medium", verify: "Confirm the parcel's bill with the county assessor." },

...
export const ASSUMPTION_META: Record<string, AssumptionMeta> = {
  rent: {
    source: "HUD rent benchmark",
    confidence: "medium",
    verify: "Check recent local rent comps for this property.",
  },
  interestRate: {
    source: "FRED owner-occupied benchmark",
    confidence: "medium",
    verify: "Replace with an actual investor lender quote.",
  },
  purchasePrice: {
    source: "Your input",
    confidence: "high",
    verify: "The contract or asking price you entered.",
  },
  vacancyPct: {
    source: "Smart default",
    confidence: "medium",
    verify: "Adjust to your submarket's real vacancy.",
  },
  mgmtPct: {
    source: "Smart default",
    confidence: "medium",
    verify: "Set to 0% if you self-manage.",
  },
  maintenancePct: {
    source: "Smart default",
    confidence: "medium",
    verify: "Older properties run higher.",
  },
  capexPct: {
    source: "Smart default",
    confidence: "medium",
  ...
  insurance: {
    source: "Estimate",
    confidence: "low",
    verify: "Get a real quote — premiums vary widely.",
  },
};

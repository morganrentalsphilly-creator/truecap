...
| Assessed / parcel tax             | A static state effective-rate dataset remains for educational market context only.                                                                                                                                              | Retired from released underwriting; parcel data missing | New analyses do not import the table. The user enters a local bill or reviewed rate; a blank field uses a disclosed generic fallback.                                                                                                                                                                                                                                                                                                                                                   |
...
| State property-tax table | Repository data                                                                | Never imported into a new released analysis; contextual market pages may omit it.                     | Educational state context only.                                                                      |

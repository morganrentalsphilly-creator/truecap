...
| Static state tax table | Educational state/market context only       | Retired from released underwriting; new analyses use a disclosed generic fallback until the user enters local evidence.                        |

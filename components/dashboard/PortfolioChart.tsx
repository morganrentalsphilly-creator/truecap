...
const CHART_COLORS = {
  light: {
    ...
    bar: "oklch(0.54 0.18 240)",
    cursor: "oklch(0.54 0.18 240 / 0.06)",
  ...
  dark: {
    ...
    bar: "oklch(0.62 0.18 240)",
    cursor: "oklch(0.62 0.18 240 / 0.14)",
      ...
      <div className="flex flex-wrap items-start justify-between gap-3 mb-6">
        <div>
          <div className="flex items-center gap-2">
            <h3 className="text-lg font-semibold">Deal Comparison</h3>

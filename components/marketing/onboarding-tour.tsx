...
const STEPS: Step[] = [
  {
    ...
    body: "Type a property address in the calculator below, review the editable rent, rate, and tax starting points, then run the free screen for cash flow, cap rate, CoC, DSCR, Deal score, and plain-English screening context.",
  ...
  // gets a personal pass/fail. The Pro laundry list rides second.
  {
    ...
    body: "Set your Buy Box—target cash flow, cash-on-cash, price range—and each deal shows which of your targets it meets or misses. Pro also includes projections, comparisons, editable sensitivity, and review reports.",
...
const PRO_STEPS: Step[] = [
  ...
  },
  {
    ...
    body: "Open Offer Ceiling to see the highest price that still meets your targets—and the rent or rate boundary for a miss.",
  ...
  },
  {
    ...
    body: "Save the property, compare it with the next opportunity, and generate a report of the assumptions, Buy Box fit, risks, and verification plan for review with a partner, lender, or client.",

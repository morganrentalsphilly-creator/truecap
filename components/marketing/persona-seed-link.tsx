...
export function PersonaSeedLink({
  ...
  return (
    <Link
      ...
      className="mt-3 inline-flex min-h-11 items-center gap-1 rounded text-sm font-semibold text-primary underline-offset-2 hover:underline focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50"
    >
      {label}

...
const PRO_STACK = [
  [Target, "Offer Ceiling", "The highest price that still meets your targets."],
  [Activity, "Downside Stress Test", "See the deal at higher vacancy, higher rates, and lower rent — before the bank does."],
  [ShieldCheck, "Buy Box screening", "Your targets screen every deal automatically — pass or miss, with reasons."],
